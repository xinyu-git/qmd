...
!function(a) {
    ...
    0 : function(a, b, c) {
        ...
        function d() {
            ...
            a.id = "page-slogan",
            a.innerHTML = "<span><b>&copy;</b> ??????????????????</span>",
            ...
            c = setTimeout(function() {
                if (!b) {
                    ...
                    c.id = "reload",
                    c.innerHTML = '<a href="javascript:location.reload()">??????????????????</a>',
                    a.appendChild(c)
                }
            },
            6e3);
        ...
        i && g.href.indexOf("index-ie.html") < 0 && g.replace("//h5.m.taobao.com/index-ie.html"),
        !i && g.hash.indexOf("autocomplete") > 0 && g.replace("#index"),
        j && k && !
        function() {
            var a = function() {
                setTimeout(function() {
                    ...
                    document.documentElement.style.height = a;
        ...
        var l, m = !1; (l = g.hostname.match(/\.(wapa|waptest)\.taobao\.com$/)) && (m = l[1]),
        e.TestEnv = m;
        try {
...
function(a) {
    a.H5INDEX_TEMPLATE = {
        t122016huichang: function(a) {
            ...
            c.setAttribute("data-template-name", "t122016huichang"),
        ...
        t112016header: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "t112016header"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        t122016renqun: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "t122016renqun"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        t122016boarder: function(a) {
            ...
            c = document.createElement("div");
            return c.setAttribute("data-template-name", "t122016boarder"),
            c.style.position = "relative",
            c.innerHTML = b,
            c
        },
        t122016huodong: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "t122016huodong"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tentrance10: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tentrance10"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tfeatures5: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tfeatures5"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        gray_border_home: function(a) {
            ...
            c = document.createElement("div");
            return c.setAttribute("data-template-name", "gray_border_home"),
            c.style.position = "relative",
            c.innerHTML = b,
            c
        },
        tcategory3: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tcategory3"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        trushbuy5: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "trushbuy5"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        toutiao2: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "toutiao2"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        t122016biaoqian: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "t122016biaoqian"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tgrayborder12: function(a) {
            ...
            c = document.createElement("div");
            return c.setAttribute("data-template-name", "tgrayborder12"),
            c.style.position = "relative",
            c.innerHTML = b,
            c
        },
        titemtop: function(a) {
            ...
            c = document.createElement("div");
            return c.setAttribute("data-template-name", "titemtop"),
            c.style.position = "relative",
            c.innerHTML = b,
            c
        },
        guessTitle: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "guessTitle"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tentrance: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tentrance"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        single_titem: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "single_titem"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        t11MallMainEntrance: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "t11MallMainEntrance"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tdarentao5: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tdarentao5"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tbanner2: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tbanner2"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tmall5: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tmall5"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tquality3: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tquality3"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        subtshop88: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "subtshop88"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tcheap3: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tcheap3"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        woyao: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "woyao"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        titem: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "titem"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tshop88: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tshop88"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tcheap5: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tcheap5"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tnotice: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tnotice"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        titemtzm: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "titemtzm"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tcategory5_header: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tcategory5_header"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        t11MallMainEntranceSmall: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "t11MallMainEntranceSmall"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tcategory5_4i4pic: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tcategory5_4i4pic"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tfeatures3: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tfeatures3"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tmore5: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tmore5"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tcategory5_2i4pic: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tcategory5_2i4pic"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        rushbuy42: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "rushbuy42"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        titembanner: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "titembanner"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tdarentao3: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tdarentao3"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        tbanner3: function(a) {
            ...
            c = document.createElement("div");
            c.setAttribute("data-template-name", "tbanner3"),
            c.style.position = "relative",
            c.innerHTML = b;
            try {
        ...
        rushbuy_counter: function(a) {
            ...
            if (b) {
                ...
                return c.setAttribute("data-ctrl-name", "counter"),
                c.setAttribute("data-enddate", b.toString()),
                c.innerHTML = '<span role="h"></span><span class="dot">:</span><span role="m"></span><span class="dot">:</span><span role="s"></span>',
                c
            }
        },
        toutiao_item: function(a) {
            ...
            return b.setAttribute("data-href", a.targetUrl),
            b.style.cssText = "width: 10rem; padding: 0.09375rem 0; height: 0.75rem;",
            b.className = "horizontal-view",
            c.style.cssText = "display: block; border-right: 1px solid #E8E8E8; width: 2.1875rem; height: 100%; box-sizing: border-box; background: url(" + a.imageUrl[0].imgUrl + ") no-repeat center center; background-size: 1.6171875rem 0.46875rem;",
            d.textContent = a.title[0].valueDesc,
            d.style.cssText = "display: block; margin: 0.125rem 0.15625rem 0.125rem 0.28125rem; padding:0 0.0625rem; height: 0.46875rem; line-height: 0.46875rem; border: 1px solid #D81421; border-radius: 0.125rem; color: #D81421; font-size: 0.375rem; text-align:center; overflow:hidden; max-width:2rem",
            e.textContent = a.title[1].valueDesc,
            e.style.cssText = "display: block; overflow:hidden; margin: 0.125rem 0; height: 0.5rem; line-height: 0.5rem; color: #353535; font-size: 0.40625rem; width: 6rem; flex:1",
            b.appendChild(c),
            b.appendChild(d),
            b.appendChild(e),
            b
        ...
        t11Headline_item: function(a) {
            ...
            d = document.createElement("span");
            return b.setAttribute("data-href", a.targetUrl),
            c.textContent = a.title[0].valueDesc,
            d.textContent = a.title[1].valueDesc,
            b.appendChild(c),
            b.appendChild(d),
            b
        },
        tbanner_items: function(a) {
            var b = document.createElement("div");
            b.className = "slide-banner",
            b.style.cssText = "height: 100%; width: 10rem; overflow: hidden; position: relative;";
            var c = document.createElement("ul");
            c.style.cssText = "height: 100%; width: 10rem; ";
            var d = document.createElement("div");
            return d.className = "indicator",
            d.style.cssText = "right: 0; height: 0.28125rem; position: absolute; bottom: 0.25rem; text-align: center;  -webkit-transform: translateZ(0); -ms-transform: translateZ(0); transform: translateZ(0);",
            a.forEach(function(a, b) {
                try {
                    var d = document.createElement("li");
                    if (d.className = "card", d.style.cssText = "display: block; width: 10rem; height: 100%;", a.bizType || (a.bizType = "WXZC"), "zuanzhan" === a.bizType.toLowerCase()) if (0 === a.targetUrl.indexOf("http")) {
        ...
        slide_pager: function(a) {
            var b = document.createElement("div");
            return b.style.cssText = "height: 100%; width: 10rem; overflow: hidden; position: relative;",
            b.innerHTML = '<div class="slide-pager" style="height:100%; width: 10rem; overflow: hidden; position: relative;"><ul style="height: 100%; width: 10rem; "></ul><div class="indicator" style=" height: 0.28125rem; right: 0px; position: absolute; bottom: 0.1rem; text-align: center; -webkit-transform: translateZ(0); -ms-transform: translateZ(0); transform: translateZ(0); z-index:1; "></div></div>',
            b
        },
        pagelayout: function() {
            var a = document.createElement("div");
            return a.setAttribute("data-ctrl-name", "scroll-view"),
            a.innerHTML = ['<div class="scroll-wrap">', '<div class="scroll-content">', "</div>", "</div>"].join(""),
            a
        },
        pageheader: function() {
            var a = document.createElement("header");
            return a.innerHTML = ['<div class="header-wrap">', '<div id="search-placeholder"><span>寻找宝贝店铺</span></div>', "</div>"].join(""),
            a
        },
        ...
        pageguessitem: function() {
            var a = document.createElement("div");
            return a.id = "guessitem",
            a.innerHTML = ['<div class="loading"><span>正在为� � 载更多内容...</span></div>'].join(""),
            a
        },
        pagebar: function() {
        ...
        pagebottom: function() {
            var a = document.createElement("div");
            return a.setAttribute("data-template-name", "pagebottom"),
            a.innerHTML = ['<div style="width: 10rem;">', '<div class="buttons">', '<a href="//www.taobao.com/index.php?from=wap">电脑版</a>', '<a href="//h5.m.taobao.com/other/feedback.html?alphatext=new_h5_index">用户反馈</a>', "</div>", '<div class="copyright">2016 浙 B2-20080224 <a>服务中心</a></div>', "</div>"].join(""),
            a
        }
    }
} (window),
...
function(a, b) {
    ...
    d.match(/Mobile\s+Safari/) ? (b.env.os.name = "Android", b.env.os.isAndroid = !0) : (b.env.os.name = "AndroidPad", b.env.os.isAndroidPad = !0);
        ...
        var e = c[1]; (c = d.match(/OS ([\d_\.]+) like Mac OS X/)) && (b.env.os = {
            name: e,
...
function(a, b) {
    ...
    j = a._ua_popLayer || "",
    k = !1,
    l = ""; (d = e.match(/AliApp\(([A-Z\-]+)\/([\d\.]+)\)/i)) && (f = !0, g = d[1], i = d[2], h = g.indexOf("-PD") > 0 ? b.env.os.isIOS ? "iPad": b.env.os.isAndroid ? "AndroidPad": b.env.os.name: b.env.os.name),
    !g && e.indexOf("TBIOS") > 0 && (g = "TB"),
    j && (d = j.match(/PopLayer\/([\d\.]+)/i)) && (k = !0, l = d[1]),
    f ? b.env.aliapp = {
...
function(a, b) {
    function c(a) {
        ...
        Object.defineProperty(this, "search", {
            ...
            get: function() {
                var a = [];
                for (var c in b) if (void 0 !== b[c]) if ("" !== b[c]) try {
        ...
        this.set = function(a) {
            ...
            this.protocol = b[1] || ("object" == typeof location ? location.protocol: ""),
            this.username = b[2] || "",
            this.password = b[3] || "",
...
function(a, b) {
    function c(a) {
        ...
        if ("number" == typeof a) b = new Date(1e3 * a);
            ...
            if (d || h) {
                ...
                i = e * l[0] + f * l[1] + g * l[2] + l[3],
                b = new Date,
                b.setSeconds(b.getSeconds() + i * (h ? -1 : 1)),
                b.setMilliseconds(0)
            }
        }
        return b || (b = new Date(a)),
        b
    }
    function d(a, b) {
        return b.replace(FORMATTER_REGEXP,
        function(b) {
            var c = b.length,
            d = b.charAt(0);
    ...
    var i = function(a) {
        ...
        b.onEnd = a.onEnd,
        b.interval = a.interval || 1e3,
        b.stringFormatter = a.stringFormatter || h,
        b.correctDateOffset = a.correctDateOffset || 0,
        b.updateElement = a.updateElement,
        b._data = {
            days: 0,
            hours: 0,
            minutes: 0,
    ...
    i.prototype = {
        start: function() {
            var a = this;
            return a.stop(),
            a._update() && (a._intervalId = setInterval(function() {
                a._update()
            },
            a.interval)),
            a
        ...
        _update: function() {
            ...
            k = 0 >= j;
            return c.totalSeconds = j,
            j -= (c.days = Math.floor(j / e)) * e,
            j -= (c.hours = Math.floor(j / f)) * f,
            j -= (c.minutes = Math.floor(j / g)) * g,
            c.seconds = j,
            c.stringValue = d(c, b.stringFormatter),
            h && (h.innerHTML = c.stringValue),
            (a = b.onUpdate) && a.call(b, c),
            k ? (b.stop(), (a = b.onEnd) && a.call(b), !1) : !0
        },
        stop: function() {
            var a = this;
            return a._intervalId && (clearInterval(a._intervalId), a._intervalId = null),
            a
        },
        setEndDate: function(a) {
            var b = this;
            return b.endDate = c(a),
            b
        }
    },
...
function(a, b) {
    ...
    l.prototype.__processRequestType = function(a) {
        ...
        a && a().then(function() {
            ...
            d.WindVaneRequest === !0 && (!a || a.indexOf("HY_FAILED") > -1 || a.indexOf("HY_NO_HANDLER") > -1 || a.indexOf("HY_CLOSED") > -1 || a.indexOf("HY_EXCEPTION") > -1 || a.indexOf("HY_NO_PERMISSION") > -1) ? (r.H5Request = !0, c.__sequence([c.__processRequestType, c.__processToken, c.__processRequestUrl, c.__processUnitPrefix, c.middlewares, c.__processRequest])) : void 0
        })
    };
    var v = "_m_h5_tk",
    w = "_m_h5_tk_enc";
    ...
    l.prototype.__processToken = function(a) {
        ...
        c.WindVaneRequest !== !0 ? p.then(function() {
            ...
            if (d instanceof Array && (d = d.join(",")), d.indexOf("TOKEN_EMPTY") > -1 || d.indexOf("TOKEN_EXOIRED") > -1) {
                ...
                maxRetryTimes > 0 && (i(v, c.mainDomain, c.subDomain), i(w, c.mainDomain, c.subDomain)),
    ...
    l.prototype.__processUnitPrefix = function(b) {
        ...
        if (o && d.H5Request === !0) {
            ...
            d.h5UnitPrefix ? d.path = d.path.replace(/^\/\//, "//" + d.h5UnitPrefix) : g && d.path && (d.useAcsUnit === !0 || d.path.indexOf("taobao.com") > -1 ? d.path = d.path.replace(/^\/\//, "//" + g) : d.path = d.path.replace(/^\/\//, "//" + g + ".")),
            b().then(function() {
                if (o) {
                    ...
                    if (b) {
                        ...
                        if (!c || b !== f.version) {
                            ...
                            a.jsonp_unitapi || (a.jsonp_unitapi = function(a) {
                                k(),
                                o.setItem("unitinfo", JSON.stringify(a))
                            }),
                            e(j)
                        }
                    }
    ...
    l.prototype.request = function(a) {
        ...
        b.options.H5Request && (b.constructor.__firstProcessor || (b.constructor.__firstProcessor = c), y = function(a) {
...
function(a, b) {
    function c(a, b) {
        ...
        function f() {
            ...
            c.className = "cur",
            c.style.backgroundPosition = "0 -0.25rem"
        }
        function g() {
            var b = a.querySelector("b");
            m ? b.className = "show": b.className = "hide",
            b.innerHTML = l + " / " + k
        }
        var h = Date.now() + "-" + ++d,
        i = document.createDocumentFragment();
        1 !== arguments.length || arguments[0] instanceof HTMLElement || (b = arguments[0], a = null),
        a || (a = document.createElement("div"), i.appendChild(a)),
        b = b || {},
        a.setAttribute("data-ctrl-name", "indicator"),
        a.setAttribute("data-ctrl-id", h);
        var j;
        Object.defineProperty(this, "direction", {
            ...
            set: function(a) {
                ...
                j = a.length > 1 ? a: "v" === a ? "vertical": "horizontal",
                c()
            }
        }),
...
function(a, b, c) {
            ...
            var k = {
                ...
                pressingHandler: setTimeout(function(b) {
                    return function() {
                        ...
                        clearTimeout(k.pressingHandler),
                        k.pressingHandler = null
                    }
    ...
    function h(a) {
        for (var b = 0; b < a.changedTouches.length; b++) {
            ...
            p = Math.sqrt(Math.pow(m, 2) + Math.pow(o, 2)); ("tapping" === g.status || "pressing" === g.status) && p > 10 && (g.status = "panning", g.isVertical = !(Math.abs(m) > Math.abs(o)), e(g.element, "panstart", {
                touch: c,
                touchEvent: a,
        ...
        for (var f = 0; f < a.changedTouches.length; f++) {
            ...
            if (p) {
                if (p.pressingHandler && (clearTimeout(p.pressingHandler), p.pressingHandler = null), "tapping" === p.status && (p.timestamp = Date.now(), e(p.element, "tap", {
                    ...
                    e(p.element, "panend", w),
                    v && (e(p.element, "flick", w), p.isVertical ? e(p.element, "verticalflick", w) : e(p.element, "horizontalflick", w))
                }
...
function(a, b) {
    ...
    function g(b) {
        ...
        this.cancel = function() {
            return d && (h = !0, o(d), c && c.reject("CANCEL")),
            this
        },
        this.clone = function() {
            return new g(b)
    ...
    function h(a, b) {
        ...
        for (var c = a / l,
        d = 1 / c,
        e = [], f = Object.keys(b).map(function(a) {
            return parseInt(a)
        }), h = 0; c > h; h++) {
            var i = f[0],
            j = d * h;
    ...
    o = window.cancelAnimationFrame || window.msCancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || d; (n === c || o === d) && (n = c, o = d),
...
function(a, b) {
    ...
    var f = new c,
    g = new d;
    b.promise = Object.create(f),
    b.promise.features = f,
    b.promise.utilities = g
} (window, window.lib || (window.lib = {})),
function(a, b, c) {
    function d(a) {
        a = a || "";
...
function(a, b) {
    ...
    function d(a) {
        if (this.v = a.v || 0, this.a = a.a || 0, "undefined" != typeof a.t && (this.t = a.t), "undefined" != typeof a.s && (this.s = a.s), "undefined" == typeof this.t) if ("undefined" == typeof this.s) this.t = -this.v / this.a;
        else {
...
function(a, b) {
    function c(a, b) {
        function c() {
            ...
            var b = m.getBoundingClientRect(); (m.width !== b.width * t || m.height !== b.height * t) && (m.width = b.width * t, m.height = b.height * t, o = b.width / 2, p = o / 15)
        }
        function e(a) {
        ...
        function i() {
            ...
            return b.style.cssText = "display: block",
            d.resolve()
        }
        function j() {
            var b = a.querySelector(".arrow");
            return b.style[f + "Transform"] = "scale(1)",
            b.style.opacity = "1",
            new lib.animation(400, lib.cubicbezier.easeIn,
            function(a, c) {
                b.style[f + "Transform"] = "scale(" + (1 - .5 * c) + ")",
                b.style.opacity = 1 - c + ""
            }).play().then(function() {
        ...
        1 !== arguments.length || arguments[0] instanceof HTMLElement || (b = arguments[0], a = null),
        a || (a = document.createElement("div"), l.appendChild(a)),
        b = b || {},
        a.setAttribute("data-ctrl-name", "loading"),
        a.setAttribute("data-ctrl-id", k),
        a.innerHTML = '<div rol="draw"><canvas></canvas><span class="arrow"></span></div><div rol="spin"><div class="circle"><span></span></div></div><span class="text"></span>';
        var m, n, o, p, q, r, s = !1,
        t = 2,
        ...
        Object.defineProperty(this, "bgcolor", {
            ...
            set: function(b) {
                ...
                a.querySelector('[rol="spin"] span').style.backgroundColor = b,
        ...
        Object.defineProperty(this, "mode", {
            ...
            set: function(a) {
                ...
                w = a,
                "spin" === w ? y ? j().then(h) : h() : "draw" === w && i().then(function() {
                    e(0)
                })
            }
        });
        ...
        Object.defineProperty(this, "arrowDirection", {
            ...
            set: function(b) {
                ...
                y = b,
                a.querySelector(".arrow").className = "arrow " + b
            }
        }),
        this.remove = function() {
            a.parentNode && a.parentNode.removeChild(a)
...
function(a, b, c) {
    ...
    function h(a, b) {
        function c(c) {
            ...
            b.fullscreen && (c.root.style.width = e.width + "px", c.root.style.height = e.height ? e.height + "px": "auto"),
            c.root.parentNode || a.appendChild(c.root);
            var f = b.transition,
            ...
            return "boolean" == typeof f && (f = function(a, c) {
                return b.transition !== !0 || 0 === i.length ? (c.current.root.style.display = "none", c.next.root.style.display = "block", n.resolve()) : (c.current.root.setAttribute("animation", "push:current"), c.next.root.style.display = "block", c.next.root.setAttribute("animation", "push:next"), n.all([d(c.current.root, g), d(c.next.root, g)]).then(function() {
                    c.current.root.removeAttribute("animation"),
                    c.current.root.style.display = "none",
                    c.next.root.removeAttribute("animation")
                }))
            }),
            p.serial([function() {
        ...
        function e(c) {
            ...
            return "boolean" == typeof f && (f = function(a, c) {
                return b.transition !== !0 ? (c.current.root.style.display = "none", c.previous.root.style.display = "block", n.resolve()) : (c.current.root.setAttribute("animation", "pop:current"), c.previous.root.style.display = "block", c.previous.root.setAttribute("animation", "pop:previous"), n.all([d(c.current.root, g), d(c.previous.root, g)]).then(function() {
                    c.current.root.removeAttribute("animation"),
                    c.current.root.style.display = "none",
                    c.previous.root.removeAttribute("animation")
                }))
            }),
            p.serial([function() {
            ...
            function() {
                return m.root.parentNode && m.root.parentNode.removeChild(m.root),
                m = c,
                m.persisted = !0,
                i.pop(),
                0 === i.length && i.push(m),
        ...
        j = {},
        k = Date.now() + "-" + ++r,
        l = document.createDocumentFragment(); ! a || a instanceof HTMLElement || (b = a, a = null),
        a || (a = document.createElement("div"), l.appendChild(a)),
        b = b || {},
        a.setAttribute("data-ctrl-name", "pageview"),
        a.setAttribute("data-ctrl-id", k),
        b.fullscreen && (a.className = "fullscreen");
        var m = new g({
            id: 0,
            args: {}
        },
...
function(a, b, c) {
    function d(a) {
        ...
        return "none" !== d && (b = d.match(/^matrix3d\((?:[-\d.]+,\s*){12}([-\d.]+),\s*([-\d.]+)(?:,\s*[-\d.]+){2}\)/) || d.match(/^matrix\((?:[-\d.]+,\s*){4}([-\d.]+),\s*([-\d.]+)\)$/)) && (c.x = parseFloat(b[1]) || 0, c.y = parseFloat(b[2]) || 0),
        c
    }
    function e(a, b) {
    ...
    function g(a, c) {
        ...
        function j(a) {
            if (0 !== r) {
                var b, c, d = q.get(a);
                r > 1 && (b = q.get(a - 1), c = 2 === r ? q.getCloned(a + 1) : q.get(a + 1), d.style.left = -o + "px", b.style.left = -o - s + "px", c.style.left = -o + s + "px"),
                t = d.index,
                g("change", {
                    prevItem: b,
                    curItem: d,
        ...
        1 !== arguments.length || arguments[0] instanceof HTMLElement || (c = arguments[0], a = null),
        a || (a = document.createElement("ul"), n.appendChild(a)),
        c = c || {},
        a.setAttribute("data-ctrl-name", "carrousel"),
        a.setAttribute("data-ctrl-id", m),
        a.style.position = "relative",
        a.style[l + "Transform"] = e(0, 0);
        var o = 0,
        q = {},
        r = 0,
        ...
        q.add = function(b) {
            ...
            c.style["float"] = "left",
            c.index = r,
            "string" == typeof b ? c.innerHTML = b: b instanceof HTMLElement && c.appendChild(b),
            a.appendChild(c),
        ...
        q.getCloned = function(b) {
            ...
            return c || (c = q[b].cloneNode(!0), a.appendChild(c), c.setAttribute("cloned", "cloned-" + b), c.index = b),
            c
        },
        q.slide = function(c) {
            if (0 !== r) {
                ...
                h = g - f;
                if (0 !== h) {
                    new b.animation(400, b.cubicbezier.ease,
                    function(b, c) {
                        a.style[l + "Transform"] = e(f + h * c, 0)
                    }).play().then(function() {
                        o = g,
                        a.style[l + "Transform"] = e(g, 0),
                        c && j(t + c)
                    })
                }
            }
        ...
        this.play = function() {
            return u ? void(v || (v = setTimeout(function() {
                ...
                500),
                v = setTimeout(arguments.callee, 400 + z)
            },
            400 + z))) : (u = !0, j(0))
        },
        this.stop = function() {
        ...
        if (Object.defineProperty(this, "playInterval", {
            ...
            var A, B = !1;
            a.addEventListener("panstart",
            function(a) {
                a.isVertical || B && w || (a.preventDefault(), a.stopPropagation(), x && k.stop(), A = 0, B = !0)
            }),
            a.addEventListener("pan",
            function(b) { ! b.isVertical && B && (b.preventDefault(), b.stopPropagation(), A = b.displacementX, a.style[l + "Transform"] = e(o + A, 0))
            }),
            a.addEventListener("panend",
            function(a) { ! a.isVertical && B && (a.preventDefault(), a.stopPropagation(), B = !1, a.isflick ? 0 > A ? q.next() : q.prev() : Math.abs(A) < s / 2 ? q.slide(0) : q.slide(0 > A ? 1 : -1), x && setTimeout(function() {
                    k.play()
                },
                2e3))
            },
            !1),
            a.addEventListener("flick",
            function(a) {
...
function(win, app) {
    ...
    function runMobile(a) {
        if (autoCalled !== location.href) {
            var b = 1e3; (!isTBApp && a.auto === !0 || isTBApp && a.callInApp === !0) && (b = 2500, app.jump.aplus({
                apuri: "callapp_auto"
...
function(a, b, c) {
    ...
    function e(a) {
        ...
        if (!b) {
            ...
            b.left = a.offsetLeft,
            b.top = a.offsetTop;
            for (var c = a.offsetParent; c;) b.left += c.offsetLeft,
            b.top += c.offsetTop,
            c = c.offsetParent;
    ...
    function i(a, b) {
        return b > a.minScrollOffset ? b = a.minScrollOffset: b < a.maxScrollOffset && (b = a.maxScrollOffset),
        b
    }
    function j(a, b, c) {
        d(a.element.scrollId, b, c);
        var e = p.createEvent("HTMLEvents");
        if (e.initEvent(b, !1, !0), e.scrollObj = a, c) for (var f in c) e[f] = c[f];
        a.element.dispatchEvent(e),
        a.viewport.dispatchEvent(e)
    }
    function k(a) {
        var b, c = {
            x: 0,
    ...
    function l(a, b) {
        ...
        0 != a && (a += "px"),
        0 != b && (b += "px"),
        A ? "translate3d(" + a + ", " + b + ", 0)": "translate(" + a + ", " + b + ")"
    }
    function m(a, b, c) {
    ...
    function n(a, b) {
        var c = 0,
        d = 0;
        "object" == typeof b ? (c = b.x, d = b.y) : "y" === a.axis ? d = b: c = b,
        a.element.style[y + "Transform"] = l(c, d)
    }
    function o(a, c) {
        function l(a) {
        ...
        function t(a) {
            if (q(a)) if (L && D(), c.useFrameAnimation) H && H.stop(),
            H = null;
            else {
                var b = k(E);
                n(E, b),
            ...
            if (q(a)) {
                ...
                if (e) {
                    ...
                    if (c.useFrameAnimation) {
                        var g = f - d;
                        H = new b.animation(400, b.cubicbezier.ease,
                        function(a, b) {
        ...
        function z(a) {
            if (q(a)) {
                ...
                c > E.minScrollOffset ? (c = E.minScrollOffset + (c - E.minScrollOffset) / K, K *= 1.003) : c < E.maxScrollOffset && (c = E.maxScrollOffset - (E.maxScrollOffset - c) / K, K *= 1.003),
                K > 4 && (K = 4);
                var d = h(E, c);
                d && (j(E, d > 0 ? "y" === E.axis ? "pulldown": "pullright": "y" === E.axis ? "pullup": "pullleft", {
                    boundaryOffset: Math.abs(d)
                }), E.options.noBounce && (c = i(E, c))),
                n(E, c.toFixed(2)),
                j(E, "scrolling")
            }
        }
        ...
        function C(a) {
            ...
            if (!C) {
                ...
                var F = 2,
                G = .0015;
                c.inertia && u[c.inertia] && (F = u[c.inertia][0], G = u[c.inertia][1]),
                e > F && (e = F),
                -F > e && (e = -F),
                f = G * (e / Math.abs(e)),
                o = new b.motion({
                ...
                if (I) {
                    ...
                    q = e,
                    r = f,
                    I > 0 ? (t = E.minScrollOffset, w = 1) : (t = E.maxScrollOffset, w = -1),
                    v = new b.motion({
                        v: w * q,
                        a: -w * r,
                        s: Math.abs(t - i)
                    ...
                    if (c.noBounce) if (d("没有回弹效果"), i !== t) if (c.useFrameAnimation) {
                        var K = t - i,
                        O = b.cubicbezier(J[0][0], J[0][1], J[1][0], J[1][1]);
                        H = new b.animation(s.toFixed(0), O,
                        function(a, b) {
                            var c = i + K * b;
                            k(E, c.toFixed(2)),
                            j(E, "scrolling", {
                        ...
                        var P = t.toFixed(0);
                        m(E, (s / 1e3).toFixed(2) + "s", "cubic-bezier(" + J + ")"),
                        n(E, P),
                        p(D, 1e3 * (s / 1e3).toFixed(2))
                    } else D();
                    else if (i !== A) if (d("惯性滚动", "s=" + A.toFixed(0), "t=" + ((s + z) / 1e3).toFixed(2)), c.useFrameAnimation) {
                        var K = A - i,
                        O = b.cubicbezier.easeOut;
                        H = new b.animation((s + z).toFixed(0), O,
                        function(a, b) {
                            var c = i + K * b;
                            n(E, c.toFixed(2)),
                            j(E, "scrolling", {
                        ...
                        var P = A.toFixed(0);
                        m(E, ((s + z) / 1e3).toFixed(2) + "s", "ease-out"),
                        n(E, P),
                        p(function(a) {
                            if (E.enabled) if (d("惯性回弹", "s=" + t.toFixed(0), "t=400"), A !== t) {
                                var b = t.toFixed(0);
                                m(E, "0.4s", "ease"),
                                n(E, b),
                                p(D, 400)
                    ...
                    if (c.useFrameAnimation) {
                        ...
                        H = new b.animation(g.toFixed(0), O,
                        function(a, b) {
                        ...
                        var P = l.toFixed(0);
                        m(E, (g / 1e3).toFixed(2) + "s", "cubic-bezier(" + Q + ")"),
                        n(E, P),
                        p(D, 1e3 * (g / 1e3).toFixed(2))
                    }
                }
                M = !0,
                c.useFrameAnimation || b.animation.requestFrame(function() {
        ...
        function D() {
            E.enabled && (N = !1, setTimeout(function() { ! N && L && (L = !1, M = !1, c.useFrameAnimation ? (H && H.stop(), H = null) : m(E, "", ""), j(E, "scrollend"))
            },
            50))
        }
        var E = this;
        if (c = c || {},
        c.noBounce = !!c.noBounce, c.padding = c.padding || {},
        null == c.isPrevent ? c.isPrevent = !0 : c.isPrevent = !!c.isPrevent, null == c.isFixScrollendClick ? c.isFixScrollendClick = !0 : c.isFixScrollendClick = !!c.isFixScrollendClick, c.padding ? (c.yPaddingTop = -c.padding.top || 0, c.yPaddingBottom = -c.padding.bottom || 0, c.xPaddingTop = -c.padding.left || 0, c.xPaddingBottom = -c.padding.right || 0) : (c.yPaddingTop = 0, c.yPaddingBottom = 0, c.xPaddingTop = 0, c.xPaddingBottom = 0), c.direction = c.direction || "y", c.inertia = c.inertia || "normal", this.options = c, E.axis = c.direction, this.element = a, this.viewport = a.parentNode, this.plugins = {},
        this.element.scrollId = setTimeout(function() {
            r[E.element.scrollId + ""] = E
        },
        1), this.viewport.addEventListener("touchstart", t, !1), this.viewport.addEventListener("touchend", w, !1), this.viewport.addEventListener("touchcancel", w, !1), this.viewport.addEventListener("panstart", x, !1), this.viewport.addEventListener("pan", z, !1), this.viewport.addEventListener("panend", A, !1), c.isPrevent && (this.viewport.addEventListener("touchstart",
        function(a) {
            B = !0
        },
        !1), E.viewport.addEventListener("touchend",
        function(a) {
            B = !1
        },
        !1)), c.isFixScrollendClick) {
            ...
            !1),
            this.viewport.addEventListener("click", l, !1),
            this.viewport.addEventListener("tap", o, !1)
        }
        if (c.useFrameAnimation) {
            var H;
            ...
            var I, J = 0;
            a.addEventListener(v ? "transitionend": y + "TransitionEnd",
            function(a) {
                if (I) {
                    var c = I;
                    I = null,
        ...
        var O, P = {
            ...
            disable: function() {
                ...
                this.options.useFrameAnimation ? H && H.stop() : b.animation.requestFrame(function() {
            ...
            refresh: function() {
                ...
                else if (this.options.useElementRect) a.style[c] = "auto",
                a.style[c] = e(a)[c] + "px";
                ...
                return this.transformOffset = k(this),
                this.minScrollOffset = f(this),
                this.maxScrollOffset = g(this),
                this.scrollTo( - this.transformOffset[this.axis] - this.options[this.axis + "PaddingTop"]),
                j(this, "contentrefresh"),
                this
            },
            offset: function(a) {
            ...
            scrollTo: function(a, c) {
                var d = this;
                this.element;
                if (a = -a - this.options[this.axis + "PaddingTop"], a = i(this, a), L = !0, c === !0) if (this.options.useFrameAnimation) {
                    var e = k(d)[this.axis],
                    f = a - e;
                    H = new b.animation(400, b.cubicbezier.ease,
                    function(a, b) {
                ...
                else this.options.useFrameAnimation || m(d, "", ""),
                n(d, a),
                D();
                return this
            },
            scrollToElement: function(a, b) {
                var c = this.offset(a);
                return c = c["y" === this.axis ? "top": "left"],
                this.scrollTo(c, b)
            },
            ...
            addPullupHandler: function(a) {
                ...
                function(c) {
                    ...
                    a.call(b, c,
                    function() {
                        b.scrollTo(b.getScrollHeight(), !0),
                        b.refresh(),
                        b.enable()
                    })
                },
            ...
            addEventListener: function(a, b, c) {
                var d = this;
                return this.element.addEventListener(a,
                function(a) {
                    b.call(d, a)
                },
                !!c),
            ...
            removeEventListener: function(a, b) {
                var c = this;
                return this.element.removeEventListener(a,
                function(a) {
                    b.call(c, a)
                }),
                this
            ...
            enablePlugin: function(a, b) {
                var c = s[a];
                return c && !this.plugins[a] && (this.plugins[a] = !0, b = b || {},
                c.call(this, a, b)),
                this
            }
        };
    ...
    b.scroll = function(a, c) {
        if (1 === arguments.length && !(arguments[0] instanceof HTMLElement)) if (c = arguments[0], c.scrollElement) a = c.scrollElement;
        else {
...
function(a, b, c) {
    ...
    function f(e, f) {
        ...
        function() {
            if ("y" === r.axis) {
                ...
                e = "正在刷新...",
                f = new c.loading;
                f.arrowDirection = "down",
                f.mode = "draw",
                f.bgcolor = "#FFF",
                f.text = d;
                var g = f.element;
                j.pullRefresh.element = g,
                j.pullRefresh.height = b,
                j.pullRefresh.processingHandler = function(a) {
                    "draw" !== f.mode && (f.mode = "draw"),
                    f.text !== d && (f.text = d),
                    f.per = Math.round(a / b * 100)
                },
                j.pullRefresh.refreshHandler = function(a) {
                    var b = !1;
                    f.text = e,
                    f.mode = "spin",
                    j.pullRefresh.handler && j.pullRefresh.handler(function() {
                        b || (b = !0, a())
                    })
                }
            }
        ...
        function() {
            if ("y" === r.axis) {
                ...
                f.text = d;
                var g = f.element;
                j.pullUpdate.element = g,
                j.pullUpdate.height = b,
                j.pullUpdate.processingHandler = function(a) {
                    "draw" !== f.mode && (f.mode = "draw"),
                    f.text !== d && (f.text = d),
                    f.per = Math.round(a / b * 100)
                },
                j.pullUpdate.updateHandler = function(a) {
                    ...
                    f.text = e,
                    f.mode = "spin",
                    j.pullUpdate.handler && j.pullUpdate.handler(function() {
                        b || (b = !0, a())
                    })
                }
            }
    ...
    function g(a) {
        ...
        c.className = "force-repaint",
        c.style.cssText = "position: absolute; top: 0; left: 0; width: 0; height: 0; font-size: 0; opacity: 1;",
        ...
        function e() {
            if (f) {
                ...
                a.filter(function(a) {
                    ...
                    var b, c;
                    "IMG" === a.tagName.toUpperCase() ? (b = [a], c = []) : (b = Array.prototype.slice.call(a.querySelectorAll("img[data-src]")), c = Array.prototype.slice.call(a.querySelectorAll("*[data-image]")), a.hasAttribute("data-image") && c.push(a)),
                    b.forEach(function(a) {
                        var b = a.getAttribute("data-src");
                        b && (a.removeAttribute("data-src"), d(b,
                        function() {
                            a.src = b
                        }))
                    }),
                    c.forEach(function(a) {
                        ...
                        b && (a.removeAttribute("data-image"), d(b,
                        function() {
    ...
    function k(a) {
        function b() {
            if (e && (Array.prototype.slice.call(c.element.querySelectorAll('.sticky, *[sticky="true"]')).forEach(function(a) {
                ...
                a.setAttribute("sticky", "initialized");
                for (var b = c.offset(a), d = b.top, e = 0; e <= f.length; e++) if (!f[e] || d < f[e].top) {
                    f.splice(e, 0, {
                        top: d,
                        el: a,
        ...
        d.className = "sticky",
        d.style.cssText = "z-index:9; position: absolute; left: 0; top: 0;" + r + "transform: translateZ(9px);",
        "y" === c.axis ? d.style.width = "100%": d.style.height = "100%",
        ...
        Object.defineProperty(this, "enable", {
            ...
            set: function(a) {
                e = !!a,
                e ? (d.parentNode || c.viewport.appendChild(d), d.style.display = "block") : d.style.display = "none"
            }
        });
        var f = [];
        c.addScrollingHandler(b),
        c.addScrollendHandler(b),
        a.checkSticky = b
    }
    function l(a) {
        function c(a) {
            ...
            new b.animation(400, b.cubicbezier.ease,
            function(a, b) {
                h.style[s + "Transform"] = "translate" + g.axis.toUpperCase() + "(" + (c + d * b) + "px) translateZ(9px)",
                g.element.style[s + "Transform"] = "translate" + g.axis.toUpperCase() + "(" + (f + i * b) + "px)"
            }).play().then(a)
        }
        function f(a) {
            var c = e(h)[g.axis],
        ...
        h.className = "refresh",
        h.style.cssText = "display: none; position: absolute; top: 0; left: 0; width: 0; height: 0; " + r + "transform: translateZ(9px)",
        "y" === g.axis ? h.style.width = "100%": h.style.height = "100%";
        var i = !1;
        Object.defineProperty(this, "enable", {
            get: function() {
                return i
            ...
            set: function(a) {
                i = a,
                i ? (h.parentNode || g.viewport.appendChild(h), h.style.display = "block") : h.style.display = "none"
            }
        }),
        Object.defineProperty(this, "element", {
            get: function() {
        ...
        Object.defineProperty(this, "width", {
            set: function(a) {
                j = a,
                "x" === g.axis && (h.style.width = j + "px", h.style[s + "Transform"] = "translateX(" + -j + "px) translateZ(9px)")
            }
        });
        var k = 0;
        Object.defineProperty(this, "height", {
            set: function(a) {
                k = a,
                "y" === g.axis && (h.style.height = k + "px", h.style[s + "Transform"] = "translateY(" + -k + "px) translateZ(9px)")
            }
        });
        var l;
        ...
        g.addScrollingHandler(function(a) {
            if (i && !o) {
                ...
                b = Math.min(b, 0),
                "y" === g.axis ? h.style[s + "Transform"] = "translateY(" + -(k + b) + "px) translateZ(9px)": h.style[s + "Transform"] = "translateX(" + -(j + b) + "px) translateZ(9px)",
                0 > b && l && l( - b)
            }
        }),
        g.addEventListener("pulldownend",
        function(a) {
            if (i && !o) {
                o = !0;
    ...
    function m(a) {
        ...
        c = n.createElement("div");
        c.className = "update",
        c.style.cssText = "display: none; position: absolute; bottom: 0; right: 0; width: 0; height: 0; " + r + "transform: translateZ(9px)",
        "y" === b.axis ? c.style.width = "100%": c.style.height = "100%";
        var e = !1;
        Object.defineProperty(this, "enable", {
            get: function() {
                return e
            ...
            set: function(a) {
                e = a,
                e ? (c.parentNode || b.viewport.appendChild(c), c.style.display = "block") : c.style.display = "none"
            }
        }),
        Object.defineProperty(this, "element", {
            get: function() {
        ...
        Object.defineProperty(this, "width", {
            set: function(a) {
                f = a,
                "x" === b.axis && (c.style.width = f + "px", c.style[s + "Transform"] = "translateX(" + f + "px) translateZ(9px)")
            }
        });
        var g = 0;
        Object.defineProperty(this, "height", {
            set: function(a) {
                g = a,
                "y" === b.axis && (c.style.height = g + "px", c.style[s + "Transform"] = "translateY(" + g + "px) translateZ(9px)")
            }
        });
        var h;
        Object.defineProperty(this, "processingHandler", {
        ...
        b.addScrollingHandler(function(a) {
            if (e) {
                ...
                d = Math.max(d, k),
                "y" === b.axis ? c.style[s + "Transform"] = "translateY(" + (k - d + g) + "px) translateZ(9px)": c.style[s + "Transform"] = "translateX(" + (k - d + f) + "px) translateZ(9px)",
                j || (d - k < .7 * ("y" === b.axis ? g: f) ? h && h(d - k) : i && (j = !0, i(function() {
                    "y" === b.axis ? c.style[s + "Transform"] = "translateY(" + g + "px) translateZ(9px)": c.style[s + "Transform"] = "translateX(" + f + "px) translateZ(9px)",
                    b.refresh(),
                    j = !1
                })))
            }
...
function(a, b, c, d) {
    ...
    h = {};
    if (g) for (var i, j = g.getAttribute("content"), k = /([^=,]+)\=([^=,]+)[,\s]*/g; i = k.exec(j);) {
        var l = i[1],
        m = i[2]; ("yes" === m || "no" === m) && (m = !("yes" !== m)),
        h[l] = m
    }
    if (a.appConfig) for (var l in a.appConfig) h[l] = a.appConfig[l];
    ...
    h.fullscreen && e.addEventListener("touchmove",
    function(a) {
        a.preventDefault()
    },
    !1),
    ...
    n.pageLoad().then(function() {
        h.fullscreen ? (f.style.width = "100%", f.style.height = "100%", f.style.overflow = "hidden") : (f.style.width = "100%", f.style.overflowX = "hidden"),
        o.start({
...
function(a, b, c, d) {
    ...
    d.loadResource = function() {
        var a;
        return a = arguments[0] instanceof Array ? arguments[0].slice(0) : Array.prototype.slice.call(arguments),
        n.pageLoad().then(function() {
            var b = [],
            c = {};
            return "object" == typeof a[a.length - 1] && (c = a.pop()),
...
function(a, b, c) {
    ...
    A = z.defer();
    i.render(),
    s.data().then(k.render),
    u.data().then(m.render),
    w.data().then(o.render),
    g.definePage("index",
    function() {
        this.show.meanwhile(function() {
            var a = this;
            return this.persisted ? void 0 : i.ready().then(function(b) {
                a.viewport.appendChild(b),
                q.attachTo(b)
            })
        }),
        this.show.ready(function() {
            ...
            this.persisted ? q.ready().then(function(a) {
                ...
                e = b[2],
                g = b[3];
                c.scrollElement.appendChild(d),
                c.scrollElement.appendChild(e),
                c.scrollElement.appendChild(g),
                c.refresh(),
                w.request(),
                A.resolve(a),
                f.CloseSlogan && f.CloseSlogan()
            })
        })
    })
},
...
function(a, b, c) {
    ...
    function e() {
        ...
        return b.appendChild(f.pageheader()),
        b.appendChild(f.pagebar()),
        i.resolve(a),
        i.promise
    }
    Object.defineProperty(b, "__esModule", {
...
function(a, b) {
    ...
    b["default"] = window.H5INDEX_TEMPLATE,
    a.exports = b["default"]
},
function(a, b, c) {
    "use strict";
    ...
    function h(a, b) {
        ...
        if (c && b.items && n.toutiao_item) {
            c.innerHTML = "",
            c.setAttribute("data-ctrl-name", "toutiao");
    ...
    function i(a, b) {
        ...
        if (c && b.items && n.t11Headline_item) {
            ...
            d.setAttribute("data-ctrl-name", "t11Headline"),
            b.items.forEach(function(a) {
...
function(a, b) { (function(a) {
        ...
        function a(a, b) {
            return a && a.forEach(function(a) {
                var b;
                if (a.imageUrl && a.imageUrl.forEach(function(a) { (b = a.imgUrl) && (b.indexOf(".png") < 0 && b.indexOf("_q50.jpg") < 0 && (b.indexOf(".jpg") > -1 || b.indexOf(".jpeg") > -1) && (b = b.replace(/\.(jpg|jpeg)/, ".$1_q50.jpg")), b.match(/gtms(\d+)\.alicdn\.com/i) && (b = b.replace(/gtms(\d+)\.alicdn\.com/i, "gw.alicdn.com")), a.imgUrl = b)
                }), (b = a.targetUrl) && b.match(/^(?:(https?|taobao)\:)?\/\//)) try {
                    b = new lib.httpurl(b);
                    var c = b.params.spm,
                    d = b.params.scm;
                    c && (b.params.spm = c.replace(/^[^\.]+\.[^\.]+/, "a215s.7406091")),
                    d && (b.params.scm = d.replace(/^[^\.]+/, "2027")),
                    "y" === b.params.homepage_native && (b.protocal = "taobao"),
                    a.targetUrl = b.toString()
                } catch(e) {
                    b = b.replace(/spm\=[^\.=&#?]+\.[^\.=&#?]+/, "spm=a215s.7406091"),
                    b = b.replace(/scm\=[^\.=&#?]+/, "scm=2027"),
                    b.indexOf("homepage_native=y") > -1 && (b = "taobao" + b.replace(/^https?\:/, "")),
                    a.targetUrl = b
                }
            }),
            a
        ...
        function c(a, b) {
            ...
            return a && a.forEach(function(a) {
                if (a.imageUrl && a.imageUrl[0] && a.imageUrl[0].imgUrl && a.imageUrl[0].imgUrl.replace("_q50.jpg", "_300x300q50.jpg"), !f && a.title && a.title[0] && a.title[0].valueDesc) {
                    for (var b = a.title[0].valueDesc, c = 0, d = 0; e - 1.5 > d && c < b.length;) b.charCodeAt(c) < 128 ? d += .5 : d++,
                    c++;
...
function(a, b) {
    "use strict";
    function c(a) {
        a.style && a.style.fontSize && (a.style.fontSize = 37.5 * parseFloat(a.style.fontSize) * f.dpr + "px"),
    ...
    function d(a) {
        ...
        if (a.style.height) b = parseFloat(parseFloat(a.style.height).toFixed(2));
            ...
            b += c,
            a.style.height = parseFloat(b.toFixed(2)) + "rem"
        }
        var e = a.style.marginTop || "0",
        f = a.style.marginBottom || "0";
        return e = e.indexOf("px") > -1 ? 0 : parseFloat(parseFloat(e).toFixed(2)),
        f = f.indexOf("px") > -1 ? 0 : parseFloat(parseFloat(f).toFixed(2)),
        b += e + f
    }
    function e(a) {
    ...
    function j(a, b) {
        ...
        b.data.section.forEach(function(b, c) {
            ...
            if (m = p.global(m, c), p[l] && (m = p[l](m, c)), n[l]) {
                var o = n[l](m, c);
                "t11VipRoomSingle" === l ? B >= C ? o = null: (g(o, B), B++) : "single_titem" === l ? B + D >= E ? o = null: (h(o, D), D++) : (("titemtop" === l || "t11GuessAlert" === l) && f(o, b), i(o)),
                o && (v.fixFontSize(o), v.fixUIButton(o), e.appendChild(o))
            }
        })
    }
    function k(a) {
...
function(a, b, c) {
    ...
    function e(a) {
        ...
        return b.fixed.topElement = a.querySelector("header"),
        b.fixed.enable = !0,
        b.fixed.bottomElement = a.querySelector("footer"),
        b.fixed.enable = !0,
        b.lazyload.realtime = !1,
        b.lazyload.enable = !0,
        b.scroll.init(),
        j.resolve(b),
        j.promise
...
function(a, b, c) {
    ...
    function g(a, b) {
        ...
        return "y" === h.env.params.isPreview && (d.previewParam = "isPreview=y"),
        a && (d.userId = a.userId, d.nick = a.nick),
        b ? (d.longitude = b.longitude, d.latitude = b.latitude, d.isPosition = !0) : d.isPosition = !1,
        q = h.mtop.request({
            ...
            if (a.data && a.data.section) {
                if (i.localStorage) {
                    ...
                    i.localStorage.setItem("MTB_H5INDEX_guessitem_json", b),
                    i.localStorage.setItem("MTB_H5INDEX_guessitem_json_crc", k["default"](b).toString())
                }
                return p.resolve(a)
            }
            return p.reject()
...
function(a, b) {
    ...
    var c, d, e = window;
    try {
        b.localStorage = c = e.localStorage,
        c.setItem("@private", "false")
    } catch(f) {
        b.localStorage = c = null
    }
    try {
        b.sessionStorage = d = e.sessionStorage,
        d.setItem("@private", "false")
    } catch(f) {
    ...
    function e() {
        return f = new i(function(a, b) {
            h.navigator.geolocation ? h.navigator.geolocation.getCurrentPosition(function(b) {
                ...
                g.sessionStorage && g.sessionStorage.setItem("MTB_H5INDEX_geolocation", JSON.stringify(c)),
                a(c)
            },
            function() {
                a(!1)
...
function(a, b, c) {
    ...
    function e(a, b) {
        ...
        e.className = "text",
        e.innerText = a.nick,
        e.href = "//h5." + c + ".taobao.com/awp/mtb/mtb.htm#!/awp/mtb/mtb.htm";
        var f = l.createElement("a");
        f.innerText = "退出",
        f.href = "//login." + c + ".taobao.com/logout.htm?tpl_redirect_url=" + encodeURIComponent(location.href),
        d.insertBefore(f, d.firstElementChild),
    ...
    function f(a) {
        ...
        d = l.createElement("a");
        d.innerText = "登录",
        d.href = "//login." + b + ".taobao.com/login.htm?tpl_redirect_url=" + encodeURIComponent(location.href);
        var e = l.createElement("a");
        e.innerText = "注册",
        e.href = "//reg.taobao.com/member/new_register.jhtml?_devenv=MobileDeviceBrowser&tg=" + encodeURIComponent(location.href),
        c.insertBefore(e, c.firstElementChild),
        c.insertBefore(d, c.firstElementChild)
    }
    function g(a) {
        var b = i.pagebottom();
        return a.isLogin ? e(a, b) : f(b),
        n.resolve(b),
        n.promise
    }
    Object.defineProperty(b, "__esModule", {
...
function(a, b, c) {
    ...
    function g(a, b) {
        ...
        return "y" === h.env.params.isPreview && (d.previewParam = "isPreview=y"),
        a && a.userId && a.nick && (d.userId = a.userId, d.nick = a.nick),
        b ? (d.longitude = b.longitude, d.latitude = b.latitude, d.isPosition = !0) : d.isPosition = !1,
        r = h.mtop.request({
            ...
            if (a.data && a.data.section) {
                if (i.localStorage) {
                    var b = JSON.stringify(a);
                    i.localStorage.setItem("MTB_H5INDEX_data_json", b),
                    i.localStorage.setItem("MTB_H5INDEX_data_json_crc", k["default"](b).toString())
                }
                return q.resolve(a)
            }
            return q.reject()
    ...
    function(a) {
        e.pageready().then(function(a) {
            h.animation.requestFrame(function(b) {
                ...
                a.viewport.style.width = c.width + "px",
                a.viewport.style.height = c.height + "px",
                g.ready().then(function(a) {
                    a.scroll.refresh()
                })
            })
        })
...
function(a, b, c) {
    ...
    f.pageready().then(function(a) {
        function b(b) {
            ...
            var d; (d = c.getAttribute("data-href")) && (0 === d.indexOf("taobao://") ? e.env.browser.isIEMobile ? location.href = d.replace(/^taobao/, "http") : i.app.jump.tip(d, {
                text: "正在打开手机淘宝...",
        ...
        h.ready().then(function(a) {
            a.addEventListener("niceclick", b, !1),
            a.fixed.bottomElement.addEventListener("click", b, !1)
        })
    })
},
function(a, b, c) {
    ...
    function f(a) {
        ...
        f = new g.countdown({
            ...
            onUpdate: function(c) {
                ...
                e = String(c.minutes),
                f = String(c.seconds);
                h.q('[role="h"]', b).innerHTML = new Array(3 - d.length).join("0") + d,
                h.q('[role="m"]', b).innerHTML = new Array(3 - e.length).join("0") + e,
                h.q('[role="s"]', b).innerHTML = new Array(3 - f.length).join("0") + f,
                a.innerHTML = b.innerHTML
            }
        });
        return f.start(),
        k.ready().then(function(b) {
...
function(a, b, c) {
    ...
    function f(a) {
        return h.data().then(function(b) {
            b && b.index && b.index.misc && b.index.misc.topbg && (a.style.backgroundImage = "url(" + b.index.misc.topbg + ")"),
            m.resolve()
        }),
        m.promise
    }
...
function(a, b, c) {
    ...
    function e() {
        if (window.H5INDEX_OP_DATA && window.smartbannerJSON) {
            ...
            return h.localStorage && h.localStorage.setItem("MTB_H5INDEX_mtdata_json", JSON.stringify(a)),
            j.resolve(a)
        }
        return f = g.mtop.request({
            ...
            return h.localStorage && h.localStorage.setItem("MTB_H5INDEX_mtdata_json", JSON.stringify(b)),
            b
        })["catch"](function() {
            var a;
            if (h.localStorage) {
    ...
    function e() {
        ...
        function b() {
            if (i.localStorage) {
                ...
                a.setSeconds(0),
                a.setMilliseconds(0),
                i.localStorage.setItem("MTB_H5INDEX_popad_closedate", a.getTime())
            }
        ...
        d.appendChild(e),
        e.setAttribute("data-ctrl-name", "popad"),
        e.setAttribute("data-dpr", p.dpr),
        e.innerHTML = '<div class="img"><a class="close" href="javascript:void 0;"></a><a class="callapp" href="javascript:void 0;"></a><a class="back" href="javascript:void 0;"></a></div>';
        ...
        this.syncViewModel = function() {
            e.style.backgroundColor = m.bgcolor || "#FFF",
            f.style.backgroundImage = "url(" + m.img + ")"
        },
        this.show = function() {
            var b;
        ...
        function(a) {
            var c = a.target;
            return a.preventDefault(),
            c === g ? b() : c === j ? b() : c === k && h.callapp.gotoPage(m.weburl),
            !1
        },
        !1),
        this.addEventListener = function() {
...
function(a, b, c) {
    ...
    function e() {
        ...
        a.appendChild(b),
        b.setAttribute("data-ctrl-name", "gotop"),
        b.setAttribute("data-dpr", l.dpr),
        b.innerHTML = "<span>&#xe603;</span>顶部",
        this.addEventListener = function() {
    ...
    function g(a) {
        ...
        return k.ready().then(function(a) {
            b.addEventListener(h.env.browser.isIEMobile ? "click": "tap",
            function() {
                a.scroll.scrollTo(0, !0)
            },
            !1),
            a.scroll.addScrollingHandler(function() {
    ...
    function e() {
        ...
        function b() {
            if (i.localStorage) {
                ...
                a.setSeconds(0),
                a.setMilliseconds(0),
                i.localStorage.setItem("MTB_H5INDEX_topsb_closedate", a.getTime())
            }
        ...
        d.appendChild(e),
        e.setAttribute("data-ctrl-name", "topsb"),
        e.setAttribute("data-dpr", r.dpr),
        e.innerHTML = '<div class="img"><a class="close"></a><a class="callapp"></a><a class="down"></a></div>';
        var f = e.querySelector(".img"),
        g = e.querySelector(".close"),
        ...
        this.syncViewModel = function() {
            e.style.backgroundColor = l.bgcolor || "#FFF",
            f.style.backgroundImage = "url(" + l.img + ")"
        },
        this.show = function() {
            var b;
        ...
        function(a) {
            var c = a.target;
            return a.preventDefault(),
            c === g ? b() : c === k ? h.callapp.download(w) : c === j && h.callapp.gotoPage(v),
            !1
        },
        !1),
        this.addEventListener = function() {
        ...
        return h.env.browser.isIEMobile || s.all([m.data(), q.ready(), k.ready()]).then(function(a) {
            ...
            d.ready(function(a) {
                ...
                d.showCB = function() {
                    ...
                    c.scrollElement.insertBefore(this.smartDom, c.scrollElement.firstElementChild),
                    c.scroll.refresh()
                },
                d.hideCB = function() {
                    c.scrollElement.removeChild(this.smartDom),
                    c.scroll.refresh()
                },
                b = a.sbLogic(d, 1)
            });
                ...
                var f = new e;
                f.viewModel = b.ucAD,
                f.addEventListener("show",
                function() {
                    c.scrollElement.insertBefore(f.root, c.scrollElement.firstElementChild),
                    c.scroll.refresh()
                },
                !1),
                f.addEventListener("hide",
                function() {
                    f.remove(),
                    c.scroll.refresh()
                },
